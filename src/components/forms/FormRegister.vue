        ...
        <div class="col-12 col-sm-8">
            <form @submit.prevent="createUser" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="from-group row mt-sm-2">
                        <label class="col-sm-2 col-form-label">Usuario:</label>
                        <div class="col-sm-8">
                            <input type="text" v-model="user" class="form-control border border-dark"
                    ...
                    <div class="from-group row mt-sm-2 my-2">
                    ...
                    <div class="from-group row mt-sm-2 my-2">
                        ...
                        <div class="col-sm-8">
                            <input type="password" v-model="passwd2" class="form-control border border-dark"
                                placeholder="******" required />
                        </div>
                    </div>
